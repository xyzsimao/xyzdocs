...
It was originally named `next-docs`, I renamed it to xyzdocs as it conflicts with Next.js Docs.

Thanks to the support from **Next.js** community, I've received a lot of suggestions along the way.
[xyzdocs](https://xyzdocs.dev) is now a framework used by my libraries and some other amazing projects.
...
The core of xyzdocs is a bunch of utilities and MDX plugins.

- **Source API** construct page trees from content source, integrated with other content providers.
- **Headless components** accelerate xyzdocs UI and other custom UI implementations.
...
Overall, it is not yet a framework without xyzdocs UI.
...
The UI implementation of xyzdocs using Tailwind CSS and Radix UI.
Its design system was inspired by Shadcn UI, using CSS variables for color utilities.

Although the structure of xyzdocs UI is even simpler than core, I've used some subtle hacks to solve the problem of `"use client"` directive.
...
Also it took me some time to come up with the [preset approach](https://xyzdocs.dev/docs/ui/theme#docsui-plugin) for integrating xyzdocs UI with Tailwind CSS projects.
...
The entire release process is handled by [Changesets](https://github.com/changesets/changesets), and I wrote the scripts to update [the template repository](https://github.com/xyzsimao/xyzdocs-ui-template) automatically.
It worked great so far.

## Thanks

[The Github repository of xyzdocs](https://github.com/xyzsimao/xyzdocs) has reached 300 stars in 2024 March, it is a new achievement for me.
Welcome to give it a star to support my work!

> Original
> https://fuma-nama.vercel.app/blog/xyzdocs
