---
title: AI & LLMs
description: Integrate AI functionality to xyzdocs.
---
...
import { rewritePath } from 'xyzdocs-core/negotiation';
...
import { isMarkdownPreferred, rewritePath } from 'xyzdocs-core/negotiation';
...
You can install the AI search dialog using xyzdocs CLI:
...
Note that xyzdocs doesn't provide the AI model, it's up to you.
