...
> This guide is mainly for **xyzdocs MDX**, see the docs of `next-validate-link` for other setups.
...
To access the `source` object outside of app runtime, configure [xyzdocs MDX Loader](/docs/mdx/loader/bun) first.
...
> For Node.js, you might need to configure `tsconfig-paths`, TypeScript transpiling, and [xyzdocs MDX Loader](/docs/mdx/loader/node).
>
