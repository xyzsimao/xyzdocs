...
xyzdocs offers the **MDX Remote** package, it is a helper to integrate Markdown/MDX content sources with xyzdocs.
You can think it as a `next-mdx-remote` with built-in plugins for xyzdocs.
