...
description: Build your own content source for xyzdocs.
---
...
```tsx
import { DocsPage, DocsBody } from 'xyzdocs-ui/layouts/docs/page';
...
xyzdocs offers a variant of [Search Integrations](/docs/headless/search).
