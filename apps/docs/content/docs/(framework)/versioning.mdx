...
xyzdocs provide the primitives for you to implement versioning on your own way.
...
Sometimes you want to version the entire website, such as https://v14.xyzdocs.dev (xyzdocs v14) and https://xyzdocs.dev (Latest xyzdocs).
