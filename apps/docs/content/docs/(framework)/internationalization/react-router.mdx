---
title: React Router
description: Support i18n routing on your React Router + xyzdocs app.
---
...
import { defineI18n } from 'xyzdocs-core/i18n';
...
import { defineI18nUI } from 'xyzdocs-ui/i18n';
...
Pass the locale to xyzdocs in your pages and layouts.
...
xyzdocs only handles navigation for its own layouts (e.g. sidebar).
...
In addition, the [`xyzdocs-core/dynamic-link`](/docs/headless/components/link#dynamic-hrefs) component supports dynamic hrefs, you can use it to attend the locale prefix.
