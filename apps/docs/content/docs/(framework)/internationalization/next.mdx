---
title: Next.js
description: Support i18n routing on your Next.js + xyzdocs app
---
...
In addition, the [`xyzdocs-core/dynamic-link`](/docs/headless/components/link#dynamic-hrefs) component supports dynamic hrefs, you can use it to prepend the locale prefix.
