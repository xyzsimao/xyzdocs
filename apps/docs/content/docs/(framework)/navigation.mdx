---
title: Navigation
description: Configure navigation in your xyzdocs app.
---

import { LinkIcon, PanelLeftDashed } from 'lucide-react';

**xyzdocs UI** provides different layouts to display content, you can specify navigation configurations via layouts.
