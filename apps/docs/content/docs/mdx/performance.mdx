---
title: Performance
description: The performance of xyzdocs MDX
icon: Rocket
---

## Overview

xyzdocs MDX is a bundler plugin, in other words, it has a higher performance bottleneck.
...
Since xyzdocs MDX works with your bundler, you can import any files including client components in your MDX files.
This allows high flexibility and ensures everything is optimized by default.

### Image Optimization

xyzdocs MDX resolves images into static imports with [Remark Image](/docs/headless/mdx/remark-image).
...
Although xyzdocs MDX can handle nearly 500+ files, it could be slow and inefficient.
