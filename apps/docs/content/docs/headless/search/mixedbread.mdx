---
title: Mixedbread
description: Integrate Mixedbread Search with xyzdocs
---
...
- **xyzdocs UI**: see [Search UI](/docs/search/mixedbread) for details.
- **Search Client**:
...
- **xyzdocs UI**: Enable [Tag Filter](/docs/search/orama#tag-filter) on Search UI.
