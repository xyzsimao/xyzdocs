...
import { DocsPage, DocsDescription, DocsTitle, DocsBody } from 'xyzdocs-ui/layouts/docs/page';
...
import { DocsPage, DocsDescription, DocsTitle, DocsBody } from 'xyzdocs-ui/layouts/notebook/page';
...
<DocsPage>
  <a
    href={`https://github.com/fuma-nama/xyzdocs/blob/main/content/docs/${page.path}`}
...
// notebook layout:
import { DocsPage, PageLastUpdate } from 'xyzdocs-ui/layouts/notebook/page';
...
<Tabs items={['xyzdocs MDX', 'GitHub API']}>
...
```tsx
import { getGithubLastEdit } from 'xyzdocs-core/content/github';
...
[TOC Utility](/docs/headless/utils/get-toc). Content sources like xyzdocs MDX offer this out-of-the-box.
