...
Enable the notebook layout with `xyzdocs-ui/layouts/notebook`.

```tsx title="layout.tsx"
import { DocsLayout } from 'xyzdocs-ui/layouts/notebook'; // [!code highlight]
...
```tsx title="layout.tsx"
import { DocsLayout } from 'xyzdocs-ui/layouts/notebook';
import { baseOptions } from '@/lib/layout.shared';
import { source } from '@/lib/source';
import type { ReactNode } from 'react';
