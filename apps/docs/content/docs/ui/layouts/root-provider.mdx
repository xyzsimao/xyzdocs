---
title: Root Provider
description: The context provider of xyzdocs UI.
---
...
import { RootProvider } from 'xyzdocs-ui/provider/react-router';
...
import { RootProvider } from 'xyzdocs-ui/provider/tanstack';
...
```jsx tab="Waku"
import { RootProvider } from 'xyzdocs-ui/provider/waku';
...
xyzdocs supports light/dark modes with [`next-themes`](https://github.com/pacocoursey/next-themes).
