    ...
    <main className="text-landing-foreground pt-4 pb-6 dark:text-landing-foreground-dark md:pb-12">
      <div className="relative flex min-h-[600px] h-[70vh] max-h-[900px] border rounded-2xl overflow-hidden mx-auto w-full max-w-[1400px] bg-origin-border">
        ...
        <div className="flex flex-col z-2 px-4 size-full md:p-12 max-md:items-center max-md:text-center">
          ...
          <div className="flex flex-row items-center justify-center gap-4 flex-wrap w-fit">
            ...
            <a
              href="https://codesandbox.io/p/sandbox/github/xyzsimao/xyzdocs-ui-template"
              target="_blank"
      ...
      <div className="grid grid-cols-1 gap-10 mt-12 px-6 mx-auto w-full max-w-[1400px] md:px-12 lg:grid-cols-2">
        <p className="text-2xl tracking-tight leading-snug font-light col-span-full md:text-3xl xl:text-4xl">
          xyzdocs is a <span className="text-brand font-medium">React.js</span>{' '}
    ...
    <>
      ...
      >
        ...
        <p className="mb-8">
          ...
          composability that engineers love — you can use xyzdocs as a library,
      ...
      <div className={cn(cardVariants())}>
        ...
        <p className="mb-4">
          ...
          <span className="text-brand">content source</span>, xyzdocs works on
          MDX, Content Collections, and even your own CMS.
        </p>
        <div className="flex flex-row w-fit items-center gap-4 mb-6">
          {[
            {
              href: 'https://github.com/xyzsimao/xyzdocs-basehub',
              text: 'BaseHub CMS',
            },
            {
              href: 'https://github.com/xyzsimao/xyzdocs-sanity',
              text: 'Sanity',
            },
            {
...
This is my first document.`}
      ...
      <div className={cn(cardVariants(), 'flex flex-col p-0 overflow-hidden')}>
        <div className="p-6 mb-2">
          ...
          <p className="mb-6">
            xyzdocs CLI creates interactive components for your docs, offering a
  ...
  return (
    <>
      ...
      <div className={cn(cardVariants({ className: 'flex flex-col' }))}>
        ...
        <p className="mb-8">
          xyzdocs is 100% powered by passion and open source community.
        </p>
        <div className="mb-8 flex flex-row items-center gap-2">
          ...
          <a
            href="https://github.com/xyzsimao/xyzdocs/graphs/contributors"
            rel="noreferrer noopener"
      ...
      >
        ...
        <li className="flex flex-row flex-wrap gap-2 mt-auto">
          ...
          <a
            href="https://github.com/xyzsimao/xyzdocs"
            rel="noreferrer noopener"
            className={cn(
              buttonVariants({
                variant: 'secondary',
